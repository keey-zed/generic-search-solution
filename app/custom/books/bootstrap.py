...
this file"). Identical wiring to app/custom/legal/bootstrap.py; this is
the whole point of the template -- the same four-file pattern producing
two visibly different applications.
"""
...
def build_search_engine(
    *,
    ...
    """Build a working `SearchEngine` for the books project. See
